...
ln -sf %{buildroot}/var/lib/nagvis/userfiles %{buildroot}%{_datadir}/%{name}/share/userfiles
ln -sf %{buildroot}/usr/share/nagvis/docs %{buildroot}%{_datadir}/doc/%{name}/html
ln -sf %{buildroot}/usr/share/nagvis/docs %{buildroot}%{_datadir}/%{name}/share/docs
ln -sf %{buildroot}/etc/nagvis %{buildroot}%{_datadir}/%{name}/etc
ln -sf %{buildroot}%{_var}/cache/%{name} %{buildroot}%{_datadir}/%{name}/var
ln -sf %{buildroot}/usr/share/nagvis/defaults/nagvis.ini.php-sample %{buildroot}%{_datadir}/doc/%{name}/nagvis.ini.php-sample
ln -sf %{buildroot}/usr/share/nagvis/defaults/apache2-nagvis.conf-sample %{buildroot}%{_datadir}/doc/%{name}/apache2-nagvis.conf-sample
ln -sf %{buildroot}/etc/nagvis/apache2.conf %{buildroot}%{_sysconfdir}/httpd/conf.d/nagvis.conf
